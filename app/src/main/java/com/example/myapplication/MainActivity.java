            ...
            public void onClick(View view) {
                if (userField.getText().toString().trim().equals("")) {
                    Toast.makeText(MainActivity.this,
                            R.string.no_user_input, Toast.LENGTH_SHORT).show();
                } else {
                    String city = userField.getText().toString();
                    String key = "041e61479b4cb2e92b34a1044e15afaa";
    ...
    private class GetURLData extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                resultInfo.setText("Temperature: " + object.getJSONObject("main").getDouble("temp") + " °C");
